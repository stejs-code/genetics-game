class Player {
    ...
    private flowers: any[];
    public x: number;
    private labelOpened: boolean;
    private openedFlower: Flower | undefined;
    private handlingFlower: boolean;
    private activeFlower: Flower | undefined;
...
class Flower {
    ...
    constructor(x: number | string, size: string, color: string, stem_size: string) {
        this.x = Number(x);
        this.inHand = false;
        ...
        const flowers: any = document.getElementById("flowers");
        ...
        const labels: any = document.getElementById("labels");
